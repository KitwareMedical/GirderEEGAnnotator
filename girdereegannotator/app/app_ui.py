    ...
    def __init__(self, server: Server):
        ...
        with self.layout:
            ...
            client.Style(
                ...
                ".expandable-list { height: 100%; }"
                ".expandable-list__content { height: calc(100% - 60px); padding: 0px; }"
                ".expandable-list__count { display: flex; justify-content: end; align-items: center; height: 30px; color: rgb(var(--v-theme-secondary)); }"
                ".expandable-list__more { display: flex; justify-content: center; align-items: center; height: 30px; }"
