    ...
    def __init__(self, server: Server):
        ...
        with self.layout:
            ...
            client.Style(
                ...
                ".fileset-input { width: 80px; height: 100%; display: flex; align-items: center; justify-content: space-around }"
                ...
                ".v-input .annotation-list-item .v-list-item-subtitle { font-size: 0.5rem; }"
